...
const ringTexts = [
  'Galaxy of love From EMIR...',//untuk deskripsi planet layer 1
  "I love you soo much",//untuk deskripsi planet layer 2
  "♡Happy Valentines Day Baby♡",//untuk deskripsi planet layer 3
...
function createHintText() {
  ...
  const context = canvas.getContext('2d');
  const fontSize = 50;
  const text = 'Happy Valentine Days!';
